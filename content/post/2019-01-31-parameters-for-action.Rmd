...
Several years ago, Florian Raudies, Swapnaa Jayaraman and I published a [paper](http://doi.org/10.1109/DEVLRN.2015.7345450) where we simulated the optic flow that infants would experience in different head/body postures.
...
we were able to simulate the *perceptual* effects of postural geometry: changes in eye height and forward translational speed that would occur when a child changed from crawling to walking.

This work has lain dormant for a few years, but I now want to pick it back up.
I'm looking for a concise, but thorough parameterization of body posture that includes the eyes, head, torso, arms, and legs.
