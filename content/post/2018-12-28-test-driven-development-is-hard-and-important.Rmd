...
I've been developing an R package that interacts with the [Databrary.org](https://databrary.org) API.
If you're curious, you can download the `databraryapi` package from this GitHub repository: <https://github.com/PLAY-behaviorome/databraryapi>.
...
```{r}
databraryapi::get_db_stats("people")
```
...
I think that the philosophy of test-driven development can help make our software AND the results and findings we derive from it more robust and reproducible.
